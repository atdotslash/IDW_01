...
const adminState = {
	...
	navigation: {
		sections: new Map([
			...
			[
				"doctors",
				{ id: "medicos-section", name: "medicos", component: renderDoctors },
			],
		]),
	},
};
...
function renderSection(sectionId) {
	...
	const section = Array.from(adminState.navigation.sections.values()).find(
...
function navigateToSection(
	...
	let section = getSectionByNameOrId(sectionId || DEFAULT_SECTION_NAME);
...
function updateNavbar() {
	...
	document
		.querySelector(UI_SELECTORS.LOGOUT_BUTTON)
